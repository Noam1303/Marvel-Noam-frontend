...
const Characters = ({ data, setData, user, setUser, Cookies, favoris, setFavoris }) => {
    ...
    const numberOfPages = async () => {
        const response = await axios.get('https://site--test-backend--7g4fljlbl5js.code.run/charPage?title=' + input)
    ...
    const fetchData = async () => {
        ...
        const response = await axios.get("https://site--test-backend--7g4fljlbl5js.code.run/characters?skip=" + pageToSkip + "&title=" + input)        
        const result = response.data 
    ...
    const autoCompletion = async (value) => {
        ...
        const response = await axios.get("https://site--test-backend--7g4fljlbl5js.code.run/characters?skip=" + pageToSkip + "&title=" + value)  
